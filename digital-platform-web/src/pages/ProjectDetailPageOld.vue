      ...
      <section class="panel project-workspace project-workspace--primary">
        ...
        <div v-else-if="workspace">
          ...
          >
            ...
            <section v-else class="project-workspace__empty-content">
              <div class="project-workspace__empty-icon">
              ...
              <h4>选择阶段节点</h4>
              <p>请在左侧导航展开阶段，然后选择一个蓝色节点查看关联产出和操作入口。</p>
            </section>
          </ProjectWorkspaceAccordion>
        </div>
      </section>
...
import ProjectWorkspaceAccordion from '../components/project-workspace/ProjectWorkspaceAccordion.vue';
