...
export const SOLUTION_DESIGN_NODE_KEY = {
  ...
  MARKETING_COST: 'marketing_cost_estimation',
...
export const SOLUTION_DESIGN_NODES = [
  ...
  { nodeKey: SOLUTION_DESIGN_NODE_KEY.MARKETING_COST, nodeName: '营销成本估算', nodeOrder: 8 },
  { nodeKey: SOLUTION_DESIGN_NODE_KEY.FINANCE_COST, nodeName: '财务成本估算', nodeOrder: 9 },
  { nodeKey: SOLUTION_DESIGN_NODE_KEY.QUOTATION_OR_TENDER, nodeName: '报价/投标', nodeOrder: 10 }
];
...
export const SOLUTION_DESIGN_UPLOAD_SLOT_KEY = {
  ...
  MARKETING_COST_ESTIMATION: 'marketing_cost_estimation_file',
...
export const SOLUTION_DESIGN_QUOTATION_FORM_STATUS = {
  DRAFT: 'draft',
  SUBMITTED: 'submitted'
};
...
export const SOLUTION_DESIGN_QUOTATION_FORM_DEFINITION = {
  nodeKey: SOLUTION_DESIGN_NODE_KEY.QUOTATION_OR_TENDER,
  documentCode: 'C18',
  formName: '报价单',
  templateName: '报价单-模板.docx',
  generatedFileNamePrefix: '报价单'
};
...
export const SOLUTION_DESIGN_COST_UPLOAD_SLOT_BY_NODE_KEY = {
  ...
  [SOLUTION_DESIGN_NODE_KEY.MARKETING_COST]: SOLUTION_DESIGN_UPLOAD_SLOT_KEY.MARKETING_COST_ESTIMATION,
