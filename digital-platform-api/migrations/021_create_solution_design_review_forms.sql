-- Solution design review form schema.
-- This migration stores C15/C16 review online-form versions and generated-file status metadata only.
-- It keeps C15 internal review and C16 customer review as separate outputs, does not add stage document items,
-- does not import sample data, connect the file platform, or generate PDF/Word/Excel files.
