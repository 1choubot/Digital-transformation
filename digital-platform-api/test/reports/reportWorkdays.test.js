...
test('resolveWeeklyRestMode uses default mode when no anchor exists', () => {
  assert.equal(
    resolveWeeklyRestMode({
...
test('expected work dates reflect single-rest and double-rest weeks', () => {
...
test('Saturday only counts in single-rest mode and Sunday never counts', () => {
